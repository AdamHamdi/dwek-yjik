                    ...
                    <div class="row">
                        <div class="col">
                            <div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="top_bar_item bg-success p-2" style="font-size:20px;color:white;">Profile du pharmacien</div>
                                   </div>
                            ...
                            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                                <nav class="main_nav ml-auto">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('commande.liste') }}">Commandes</a></li>
                                        <li><a href="{{ route('livreurs.liste') }}">Livreurs</a></li>
                                        <li><a href="{{ route('factures.liste') }}">Factures</a></li>
            ...
            <div class="menu_inner menu_mm">
                <div class="menu menu_mm">
                    <ul class="menu_list menu_mm">
                        ...
                        <li class="menu_item menu_mm"><a href="{{ route('commande.liste') }}">Commandes</a></li>
                        <li class="menu_item menu_mm"><a href="{{ route('livreurs.liste') }}">Livreurs</a></li>
