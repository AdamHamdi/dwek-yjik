...
<div class="row mt-5">
    <div class="col-md-6 offset-3 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('pharmacien/'.$pharmacien->id) }}"  method="post" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT" />
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="nom">Nom* </label>
                      <input type="text" class="form-control" required id="name" name="nom"  value='{{$pharmacien->nom}}' placeholder="Nom " >
                      @if($errors->get('nom'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="name" name="prenom" value='{{$pharmacien->prenom}}' placeholder="Prenom"" >
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" required id="name" name="ddn" value='{{$pharmacien->ddn}}' placeholder="date de naissance " >
                        @if($errors->get('ddn'))
                      ...
                      <div class="form-group" >
                        ...
                        <input type="text" class="form-control" required id="adresse" name="adresse" value='{{$pharmacien->adresse}}' placeholder="Adresse">
                      ...
                      <div class="form-group" >
                        ...
                        <input type="tel" class="form-control" required id="tel" name="tel" value='{{$pharmacien->tel}}' placeholder="Numéro de téléphone">
                        @if($errors->get('tel'))
                    ...
                    <div class="form-group" >
                      ...
                      <input type="email" class="form-control" required id="email" name="email" value='{{$pharmacien->email}}'placeholder="Email">
                      @if($errors->get('email'))
