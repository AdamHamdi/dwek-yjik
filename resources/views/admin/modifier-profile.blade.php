            ...
            <div class="card-body">
                ...
                <input type="hidden" name="_method" value="PUT" />
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required id="name" name="nom"  value='{{$admin->nom}}' placeholder="Nom " >
                      @if($errors->get('nom'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="name" name="prenom" value='{{$admin->prenom}}' placeholder="Prenom"" >
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" required id="name" name="ddn" value='{{$admin->ddn}}' placeholder="date de naissance " >
                        @if($errors->get('ddn'))
                      ...
                      <div class="form-group" >
                        ...
                        <input type="text" class="form-control" required id="adresse" name="adresse" value='{{$admin->adresse}}' placeholder="Adresse">
                      ...
                      <div class="form-group" >
                        ...
                        <input type="tel" class="form-control" required id="tel" name="tel" value='{{$admin->tel}}' placeholder="Numéro de téléphone">
                        @if($errors->get('tel'))
                    ...
                    <div class="form-group" >
                      ...
                      <input type="email" class="form-control" required id="email" name="email" value='{{$admin->email}}'placeholder="Email">
                      @if($errors->get('email'))
